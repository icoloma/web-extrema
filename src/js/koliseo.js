...
Koliseo.resources = {
  en: {
    ...
    buy: 'Register for ',
    empty: 'No courses scheduled. <a href="mailto:training@extrema-sistemas.com?subject=New+Courses" target="_blank">Get in contact with us</a> if you would like to get notified of any changes or if you are interested in organizing an in-company course.',
    dateFormat: 'Ddd Mm* d*',
    weekStart: 0,
  ...
  es: {
    ...
    empty: 'No hay cursos programados. <a href="mailto:training@extrema-sistemas.com?subject=New+Courses" target="_blank">Ponte en contacto</a> para recibir una notificación ante posibles cambios o si estás interesado en organizar un curso in-company.',
...
$window.scroll(throttle(check, 500))
//$window.resize(throttle(check, 500))
